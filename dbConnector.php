...
$username = "jcampbell2052"; // update with your mySQL username
$password = "zQj2DWLynTqFLTWS"; // update with your mySQL password
$database = "jcampbell2052"; // update with the database name to be used. 
